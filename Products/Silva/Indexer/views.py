...
class IndexerEditForm(silvaforms.SMIForm):
    ...
    description = _(
        "An index is not editable. "
        "However, you can update the index to include recent added content.")
    ...
    @silvaforms.action(
        ...
        description=_("Update index to include recent added content"))
    def update_index(self):
        self.context.update()
        notify(ObjectModifiedEvent(self.context))
        self.send_message(
            _("Index content have been successfully updated."),
            type="feedback")
